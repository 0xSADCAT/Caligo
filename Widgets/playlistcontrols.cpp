...
PlaylistControls::PlaylistControls(Playlist *pl, QWidget *parent) : QWidget(parent)
{
    ...
    clearButton->setIcon(QPixmap(":/img/clear24"));

    savePlaylist->setIcon(style()->standardIcon(QStyle::SP_DialogSaveButton));
    loadPlaylist->setIcon(style()->standardIcon(QStyle::SP_FileDialogDetailedView));

    forceScanButton->setIcon(style()->standardIcon(QStyle::SP_BrowserReload));
