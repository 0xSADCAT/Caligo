...
void PlayInfo::mediaStatus(QMediaPlayer::MediaStatus status)
{
    ...
    case QMediaPlayer::MediaStatus::LoadedMedia:
        ...
        _image->setPixmap(
                    qvariant_cast<QPixmap>(_player->metaData(QMediaMetaData::CoverArtImage)).isNull()
                    ? qvariant_cast<QPixmap>(_player->metaData(QMediaMetaData::ThumbnailImage))
                    : qvariant_cast<QPixmap>(_player->metaData(QMediaMetaData::CoverArtImage)));
        break;
...
void PlayInfo::videoAvailableChanged(bool video_available)
{
    _is_video = video_available;
    _image->setVisible(not video_available);
    _author->setVisible(not video_available);
    _video->setVisible(video_available);
